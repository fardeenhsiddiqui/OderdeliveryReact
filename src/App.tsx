...
function App() {
  ...
  const handleOrder = () => {
    alert(
      "Ordering " + state.selectedItem.name + " for " + state.selectedItem.price
    );
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col-sm-8">
          ...
          <h2>
            <small className="text-muted">Welcome to The Crabby Fish.</small>
          </h2>
          ...
          <div>
            <p className="h4">Review your order:</p>
            <div className="col-sm-8">
              <p className="h6">{state.selectedItem.name}</p>
              <p className="h6">
                <em>
                  <strong>{state.selectedItem.description}</strong>
                </em>
              </p>
              <p className="h6">Price - {state.selectedItem.price}</p>
              <p className="h6">Ready in {state.selectedItem.waitTime}</p>
              <img
